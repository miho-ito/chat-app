import { AppState, CurrentRoom } from "../types/store";
...
const reducer: Reducer = (state: AppState = initialState, action) => {
  switch (action.type) {
